...
- fast - fasted tested on vs2017 in x86 and x64 (for all digit lengths, uniform random bits, and uniform random digit lengths) using https://github.com/jeaiii/itoa-benchmark
